    ...
    return (
        ...
        <div className="container">
                ...
                <h2>commuter Signup</h2>
                    ...
                    <input type="password" name="password" id="" required onChange={handleInputChange} /><br />
                    <label htmlFor="">Confirm new password</label><br />
                    <input type="password" name="passwordconfirm" id="" onChange={handleInputChange} required /><br />
